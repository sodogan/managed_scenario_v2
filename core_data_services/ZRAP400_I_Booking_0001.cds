...
define view entity ZRAP400_I_Booking_0001
  as select from ZRAP400_BOOK0001
  association to parent ZRAP400_I_Travel_0001 as _Travel on $projection.TravelID = _Travel.TravelID
